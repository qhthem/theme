 ...
 * Time: 下午2:09
 */
namespace extend\Alipay\f2fpay\service;
use extend\Alipay\aop\request\AlipayTradePrecreateRequest;
use extend\Alipay\aop\AopClient;
use extend\Alipay\f2fpay\model\result\AlipayF2FPrecreateResult;
